...
{
    public sealed class WeeklyPayrollEmployeeCollection : IEnumerable<WeeklyPayrollEmployee>
    {
        public WeeklyPayrollEmployeeCollection(IEnumerable<WeeklyPayrollEmployee> source)
        {
            _Source = source ?? throw new ArgumentNullException(nameof(source));
            Computed = false;
        }

        private readonly IEnumerable<WeeklyPayrollEmployee> _Source;
        ...
        public IEnumerator<WeeklyPayrollEmployee> GetEnumerator()
        {
