...
{
    internal sealed class ExportSemiMonthlyPaySlip : ExportExcelBase
    {
        private const string CONFIG_PREFIX = "PaySlip.SemiMonthly";

        public ExportSemiMonthlyPaySlip(SemiMonthlyPayroll payroll, IEnumerable<SemiMonthlyPayrollEmployee> payrollEmployees)
        {
        ...
        private void Write(SemiMonthlyPayrollEmployee payrollEmployee)
        {
